...
const StaffDashboard: React.FC = () => {
  ...
  const [summaryData, setSummaryData] = useState({
    ...
    statusDistribution: {
      labels: ['Pre-Review', 'Double-Blind', 'Accepted', 'Published', 'Rejected'],
      data: Array(5).fill(0)
    }
  });
      ...
      return (
        <div className="p-6 bg-white rounded-lg shadow">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">Overall Summary Report - {selectedYear}</h2>
          ...
          <div className="grid grid-cols-4 gap-4 mb-8">
            <div className="p-4 bg-blue-100 rounded-lg">
              ...
              <p className="text-2xl font-bold">{summaryData.manuscriptStats.totalSubmissions}</p>
            </div>
            <div className="p-4 bg-green-100 rounded-lg">
              <h3 className="text-lg font-semibold">Accepted</h3>
              <p className="text-2xl font-bold">{summaryData.manuscriptStats.accepted}</p>
            </div>
            <div className="p-4 bg-red-100 rounded-lg">
              <h3 className="text-lg font-semibold">Rejected</h3>
              <p className="text-2xl font-bold">{summaryData.manuscriptStats.rejected}</p>
            </div>
            <div className="p-4 bg-yellow-100 rounded-lg">
              <h3 className="text-lg font-semibold">In Review</h3>
              <p className="text-2xl font-bold">{summaryData.manuscriptStats.inReview}</p>
            </div>
          </div>
